...
- Session 开始 → 读 Memory Bank（`docs/activeContext.md` + `docs/projectbrief.md` + `docs/productContext.md` + `docs/techContext.md` + `docs/systemPatterns.md` + `docs/project-status.md`）和设计原则（`docs/principles/`）
...
- 学到新的设计哲学/架构理念 → 在 `docs/principles/` 下新增文件
